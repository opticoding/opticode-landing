...
export const translations = {
  en: {
    ...
    hero: {
      ...
      taglinePart1: 'Full-Stack Development',
      taglinePart2: 'Digital Solutions',
      intro: 'I\'m David Mattiasson. With 13 years of IT and web development experience, plus a Master\'s degree from Chalmers University, I build',
      highlight: 'Advanced Web Applications',
      introEnd: 'with intuitive UX that drive real business results.',
  ...
  sv: {
    ...
    hero: {
      companyName: 'OptiCode AB',
      taglinePart1: 'Webbutveckling',
      taglinePart2: 'Digitala Lösningar',
      intro: 'Jag heter David Mattiasson. Med 13 års erfarenhet inom IT och webbutveckling samt en masterexamen från Chalmers Tekniska Högskola bygger jag',
      highlight: 'Avancerade Webbapplikationer',
      introEnd: 'med intuitiv UX som ger verkliga affärsresultat.',
