  ...
  return (
    <section className="relative w-full overflow-hidden lg:min-h-0">
      ...
      <div className="relative z-[1] w-full max-w-desktop mx-auto px-4 sm:px-8 lg:px-16 lg:py-[300px] py-8 xs:py-24">
        ...
        {/* Hero Content Wrapper - Flex container only on mobile */}
        <div className="flex flex-col lg:block items-center w-full mt-[calc(76px+2rem)] lg:mt-0">
          ...
          {/* Scroll Indicator - Below content on mobile, absolutely positioned on desktop */}
          <div className={`w-full flex justify-center items-center mt-12 mb-4 lg:absolute lg:bottom-4 lg:left-0 lg:mt-0 lg:mb-0 transition-opacity duration-300 ${showMouseIcon ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
